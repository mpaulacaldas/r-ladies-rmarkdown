...
- Documentos con [dashboards o Shiny aps](https://bookdown.org/yihui/rmarkdown/dashboards.html)
...
.center[
![Sticker en forma de hexágono del paquete rmarkdown](https://github.com/rstudio/rmarkdown/raw/master/man/figures/logo.png)
]
]
...
- Están dentro de las llaves <br>`{r option=value}`

- Con opciones separadas por comas<br>`{r option1=value, option2=value}`
